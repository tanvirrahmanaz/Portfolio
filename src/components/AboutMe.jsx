    ...
    <section id="about" className="py-20 overflow-hidden">
      <div className="container mx-auto px-4">
        ...
        <div className={`text-center mb-16 transition-all duration-1000 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'
          ...
          <div className={`w-24 h-1 bg-gradient-to-r from-blue-500 to-indigo-600 mx-auto rounded-full transition-all duration-1000 ${isVisible ? 'scale-x-100' : 'scale-x-0'
            }`}></div>
        </div>
        ...
        <div className="max-w-6xl mx-auto">
          <div className="grid lg:grid-cols-3 gap-6">
            ...
            <div className={`lg:row-span-2 bg-gray-800 rounded-xl p-6 shadow-xl border border-gray-700 
              ...
              hover:border-blue-400 group ${animateCards ? 'opacity-100 translate-x-0' : 'opacity-0 -translate-x-20'
              }`}
            ...
            <div className={`lg:col-span-2 bg-gray-800 rounded-xl p-6 shadow-xl border border-gray-700 
              ...
              transition-all duration-500 cursor-pointer group ${animateCards ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-20'
              }`}
          ...
          <div className={`mt-6 relative overflow-hidden rounded-xl shadow-xl group cursor-pointer
            ...
            transition-all duration-700 hover:scale-105 hover:shadow-2xl ${animateCards ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-20'
            }`}
            ...
            <div className="relative p-6 text-white">
              <div className="flex items-center justify-between mb-3">
                <h4 className="text-xl font-semibold flex items-center text-yellow-300">
